...
<div align="center">
  <div align="left">
    <table width="975" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#000000">
      <tr>
        <td><img src="../imagenes/mapaweb.gif" alt="Mapa de la web brcmedia.com" name="Image1" width="19" height="15" border="0" id="Image"> <a href="../mapaweb.html" class="mbrocos" title="Mapa de la web brcmedia.com">Mapa Web</a> /&nbsp;<a class="mbrocos" href="../avisolegal/avisolegal.php" title="Aviso Legal de BRCmedia">Aviso Legal </a>/ <strong>&copy;</strong> mart&iacute;n brocos. Telf: <font color="#FFFFFF">977 11 09 93</font> / M&oacute;vil: <font color="#FFFFFF">636 84 25 10</font></td>
      </tr>
    </table>
      ...
      <tr>
        <td width="708" align="center" valign="top">&nbsp;<br>
            <table width="627" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><p><img src="../imagenes/titvideos2.jpg" alt="Galería de vídeos de Brcmedia.com" width="627" height="31"></p></td>
              </tr>
            </table>
          <table width="627" border="0" cellspacing="0" cellpadding="0">
              <tr>
          ...
          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="top"><strong>Vídeo título: <?php echo $video; ?></strong><br>
                &nbsp;<br>
                <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','600','height','450','title','Vídeos brcmedia.com <?php echo $video; ?>','src','info/<?php echo $video; ?>/brcmedia','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','menu','false','wmode','transparent','movie','info/<?php echo $video; ?>/brcmedia' ); //end AC code
                    </script>
                <noscript>
                  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="600" height="450" title="Vídeos brcmedia.com <?php echo $video; ?>">
                    <param name="movie" value="info/<?php echo $video; ?>/brcmedia.swf">
                    <param name="quality" value="high">
                    <param name="menu" value="false">
                    <param name="wmode" value="transparent">
                    <embed src="info/<?php echo $video; ?>/brcmedia.swf" width="600" height="450" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" menu="false" wmode="transparent"></embed>
                  </object>
                </noscript></td>
            </tr>
          </table>
          <br>
          <br>
          <p><a class="brcmedia" href="javascript:window.history.back();" title="Volver a la p&aacute;gina anterior"><img src="../imagenes/volver.gif" alt="Volver a la página anterior" width="26" height="26" border="0"></a><br>
          </p>
        ...
        <td width="267" valign="top">&nbsp;<br>
            <table width="256" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><p><strong>Listado de vídeos realizados</strong><br>
</p></td>
              </tr>
            </table>
               
