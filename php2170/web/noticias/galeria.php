...
<html>
<head>
<title>Noticias de Brcmedia.com</title>
<link rel="shortcut icon" href="http://www.brcmedia.com/favicon.ico">
<meta name="description" content="Principales noticias generadas en Brcmedia.com">
<meta name="keywords" content="noticias,news,newsletter,hosting,web,diseño,programación,mail,dominio,brcmedia">
      ...
      <tr>
        <td width="708" align="center" valign="top">&nbsp;<br>
            <table width="627" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><p><img src="../imagenes/titnoticias2.jpg" alt="Noticias de empresa de Brcmedia.com" width="627" height="31"></p></td>
              </tr>
            </table>
          <table width="627" border="0" cellspacing="0" cellpadding="0">
              <tr>
...
?>
        ...
        <td width="267" valign="top">&nbsp;<br>
          <table width="256" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><p><strong>Noticias</strong><br>
              </p></td>
            </tr>
          </table>
           
