...
?>
<?php
$info = "info/".$oferta."/info.php"; 
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<title>Ofertas de Brcmedia.com Producto: <?php echo $foto; ?></title>
      ...
      <tr>
        <td width="708" align="center" valign="top">&nbsp;<br>
            <table width="627" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><p><img src="../imagenes/titofertas.jpg" alt="Ofertas de Brcmedia.com" width="627" height="31"></p></td>
              </tr>
            </table>
          <table width="627" border="0" cellspacing="0" cellpadding="0">
              <tr>
          ...
          <table width="627" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="top"><div align="center"><a href="javascript:window.history.back();" title="Volver a la p&aacute;gina anterior"><img src="info/<?php echo $oferta; ?>/foto.jpg" alt="Oferta <?php echo $oferta; ?>. Haga clic en la imagen para volver a la página anterior" border="0"></a></div></td>
            </tr>
          </table>  
          ...
          <table width="627" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><a class="brcmedia" href="javascript:window.history.back();" title="Volver a la p&aacute;gina anterior"><img src="../imagenes/volver.gif" alt="Volver a la página anterior" width="26" height="26" border="0"></a></td>
            </tr>
          </table>
          <p><br>
          </p>
